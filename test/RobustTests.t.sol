...
contract RobustTests is Test {
    ...
    function test_gasLimitProtection() public {
        ...
        vm.prank(buyer);
        khoop.purchaseEntries(10, powerCycle);
    ...
    function test_maximumEntriesPerTx() public {
        ...
        vm.prank(buyer);
        khoop.purchaseEntries(maxEntries, powerCycle);

        // Should fail with 11 entries
        vm.expectRevert();
        vm.prank(buyer);
        khoop.purchaseEntries(11, powerCycle);
    }
    ...
    function test_dailyLimitProtection() public {
        ...
        vm.expectRevert();
        vm.prank(user);
        khoop.purchaseEntries(50, powerCycle);
    }
    ...
    function test_invalidReferrerProtection() public {
        ...
        vm.expectRevert();
        vm.prank(buyer);
        khoop.purchaseEntries(1, invalidReferrer);
